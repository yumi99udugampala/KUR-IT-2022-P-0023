...
<title>Lingua - Start Language Learning</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Lingua Language Learner</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">WELCOME TO LINGUA</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">
				Skill Development - Language Learning - International Languages</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Learn languages online anytime, anywhere! Our interactive lessons, real-time practice, and expert tutors help you build fluency and confidence&mdash;perfect for beginners to advanced learners.
</p>
				</div>
